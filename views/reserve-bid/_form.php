                    ...
                    "change" => "function() {
                            $.ajax({
                                ...
                                success: function(response){
                                    ...
                                    $('#reservebid-technic_type_subgroup_id').html(data);
                                    
                                    $('#reservebid-technic_type_subgroup_id').val(currentValue);
                                }
                            });   
                        }",
                ],
                    ...
                    "change" => "function() {
                            $.ajax({
                                ...
                                success: function(response){
                                    ...
                                    $('#reservebid-technic_id').html(data);
                                    
                                    $('#reservebid-technic_id').val(currentValue);
                                }
                            });   
                        }",
                ],
